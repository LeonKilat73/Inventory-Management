...
// i.e. anything not kicked off by a browser holding a PKCE code_verifier
// cookie) come back as a hash-fragment token
// (#access_token=...&refresh_token=...), not a `?code=` query param. A
// fragment never reaches the server, so this has to run client-side rather
// than as a route handler. `?code=` is also handled, in case a future flow
// ends up using PKCE instead.
