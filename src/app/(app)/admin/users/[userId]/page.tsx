...
export default async function ManageUserPage({
  ...
  return (
    <div className="max-w-4xl space-y-8">
      <div>
        <h1 className="text-2xl font-semibold text-foreground">{profile.full_name}</h1>
      ...
      <div>
        <h2 className="mb-1 text-lg font-semibold text-foreground">Permission overrides</h2>
        ...
        {canEdit ? (
          ...
          <p className="text-sm text-zinc-500">You don&apos;t have permission to edit overrides.</p>
        )}
      </div>
    </div>
  );
